...
const Productos = () => {
	...
	const onDelete = async (id) => {
		try {
			const { data } = await ApiRequest().post('/eliminar-producto', { id: id })
			setMensaje({
	...
	const onSubmit = async () => {
		try {
			const { data } = await ApiRequest().post('/guardar-producto', body)
			handleDialog()
	...
	const onEdit = async () => {
		try {
			const { data } = await ApiRequest().post('/editar-producto', body)
			handleDialog()
			setBody(initialState)
			setMensaje({
				ident: new Date().getTime(),
